...
#Usted conoce a sus vecinos:
 A = sum(Cancun$Usted.conoce.a.sus.vecinos. == 'SI')
 B = sum(Cancun$Usted.conoce.a.sus.vecinos..A.alguno.le.confiaría.a.los.niños == 'SI')
 C = sum(Cancun$Usted.conoce.a.sus.vecinos..A.alguno.le.confiaría.su.casa == 'SI')
...
#3
    ...
    B = sum(Cancun$Usted.conoce.a.sus.vecinos..Le.interesaría.participar == 'SI')
    total = c(A, B)
    A = as.integer((A/N)*100)
    B = as.integer((B/N)*100)
    n = c(A, B)
    RESPUESTA = c("Participa con ellos para mejorar la seguridad", "Interesaría participar con ellos para mejorar la seguridad")
    dataC3 <- data.frame(n,RESPUESTA,   total)
    GPSC3 = graficarPlot(dataC3,"Respuesta", "Numero de personas", "3. Participa con la autoridad para mejorar la seguridad:" )
    TPSC3 = graficarTable(dataC3,"Respuesta","Numero de personas", "3. Participa con la autoridad para mejorar la seguridad:")
...
dataC4 <- data.frame(n,RESPUESTA,   total)
GPSC4 = graficarPlot(dataC4 ,"Respuesta", "Numero de personas",  "4. Día en que podría participar en actividades con la autoridad*")
TPSC4 = graficarTable(dataC4 ,"Respuesta", "Numero de personas",  "4. Día en que podría participar en actividades con la autoridad*")
...
dataC5 <- data.frame(n,RESPUESTA,   total)

GPSC5 = graficarPlot(dataC5,"Respuesta", "Numero de personas", "5. Horarios en los que podría participar en actividades con la autoridad " )
TPSC5 = graficarTable(dataC5,"Respuesta","Numero de personas", "5. Horarios en los que podría participar en actividades con la autoridad ")
...
A = sum(Cancun$En.esta.casa...APLICA.TARJETON..Todos.se.conocen == 'SI')
B = sum(Cancun$En.esta.casa...APLICA.TARJETON..Platican.unos.con.otros == 'SI')
C = sum(Cancun$En.esta.casa...APLICA.TARJETON..Comen.juntos == 'SI')
D = sum(Cancun$En.esta.casa...APLICA.TARJETON..Se.ayudan.con.los.gastos == 'SI')
E = sum(Cancun$En.esta.casa...APLICA.TARJETON..Discuten == 'SI')
FF = sum(Cancun$En.esta.casa...APLICA.TARJETON..Se.gritan.entre.sí == 'SI')
G = sum(Cancun$En.esta.casa...APLICA.TARJETON..Llegan.a.los.golpes == 'SI')
H = sum(Cancun$En.esta.casa...APLICA.TARJETON..Se.ignoran == 'SI')
...
dataC24 <- data.frame(n,RESPUESTA,   total)
GPSC24 = graficarPlot(dataC24,"Respuesta", "Numero de personas", "24. En esta casa:  " )
TPSC24 = graficarTable(dataC24,"Respuesta","Numero de personas", "24. En esta casa:   ")
