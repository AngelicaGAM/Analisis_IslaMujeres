...
#Identidad  y comunidad
  ...
  output$txt2 <- renderText({
    ...
    if(any('DE05_ingreso_sem'==input$show_vars)){
      word <- paste("<b>","o El Ingreso semanal está categorizado de la siguiente manera: ","</b>",tags$ul(
        tags$li("A - $0 a $1200"), 
  ...
  output$txt3 <- renderText({
    ...
    if(any('DE08_tmp'==input$show_vars)){
      word <- paste("<b>","o El tiempo que tarda el jefe de familia en llegar a su trabajo está categorizado de la siguiente manera: ","</b>",tags$ul(
