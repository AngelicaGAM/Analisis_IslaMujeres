  ...
  output$tableInfo <- renderDT({
    sketch <- tags$table(
      ...
      tableHeader(c("", c("Info.Sexo"="Sexo",
                          ...
                          "V01_Casa_Adultos"="Núm.Adultos","V02_Casa_Ninos"="Núm.Niños","DF_kinder"="Cúantos.Kinder",
                          "DF_primaria"="Cúantos.Primaria","DF_secundaria"="Cúantos.Secundaria","DF_bachillerato"="Cúantos.Bachillerato","DF_licenciatura"="Cúantos.Licenciatura",
                          ...
                          "DE02_trabajo"="Jefe.Trabajo","DE03_puesto"="Jefe.Puesto","DE05_ingreso_sem"="Ingreso.Sem","DE06_esc_jefe"="Jefe.Escolaridad","DE07_sIngreso"="Cúantos.Sin.Ingreso",
