  ...
  sidebarMenu(id="tabs",
              ...
              conditionalPanel(
                ...
                selectInput( "selec", "Seleccionar repositorio:",
                             c("Características de población y migración","Percepción de seguridad"),
                             selected = "Características de población y migración" , multiple = FALSE, width = 310),
                ...
                conditionalPanel(
                  ...
                  selectizeInput("show_vars", "Campos posibles a elegir:",
                                 ...
                                 , selected = c("Info.Sexo", "Edad"="Info.Edad","Religion"="IyC06_Religion" ) , multiple = TRUE, width = 310)
                ),
                conditionalPanel(
                  ...
                  selectizeInput("show_vards", "Campos posibles a elegir:",
                                 c("Participa.Eventos.Deportivos",	"Participa.En.Fiestas",	"Participa.En.Iglesia.Templo",	"Part.Solución.Problemas.Comunidad"="Participa.Solucion.Problemas.Comunidad",
                                   ...
                                   "Durante.Últ.Año.Robo.Negocio"="Durante.Ultimo.Ano.Hubo.Robo.Negocio",	"Durante.Últ.Año.Robo.De.Vehículo"="Durante.Ultimo.Ano.Hubo.Robo.De.Vehiculo",	"Durante.Último.Año.Hubo.Balaceras"="Durante.Ultimo.Ano.Hubo.Balaceras",	"Durante.Últ.Año.Violencia.Familiar"="Durante.Ultimo.Ano.Hubo.Violencia.Familiar",	"Riesgo.Sufrir.Delito.En.Casa",	"Riesgo.Sufrir.Delito.En.Calle",
                                   ...
                                   "Hay.Basura",	"Hay.Autos.Abandonados",	"Hay.Casas.Abandonadas",	"Hay.Vandalismo",	"Hay.Grafiti",	"Hay.Venta.Alcohol.Cigarros.A.Menores",	"Hay.Venta.Droga",	"Venta.Alcohol.Después.Once.Noche"="Hay.Venta.Alcohol.Despues.De.Once.Noche",	"Algun.Menor.Abandono.Escuela",	"Menor.Tiene.Problemas.Conducta"="Algun.Menor.Tiene.Problemas.Conducta",	"Algun.Menor.Quedo.Embarazada",	"Corregir.Niños.Recomienda.Castigarle"="Corregir.Ninos.Recomienda.Castigarle",	"Corregir.Niños.Recomienda.Gritarle"=	"Corregir.Ninos.Recomienda.Gritarle",
    ...
    tabItem(tabName = "asociation",
            tabsetPanel(
              tabPanel('Grafo',
                       ...
                       br(),
                       br(),
                       htmlOutput("txt4"),tags$head(tags$style("#txt4{font-size: 17px;font-style: italic;}")),
                       br(),
                       htmlOutput("txt45"),tags$head(tags$style("#txt45{font-size: 17px;font-style: italic;}")),
                       br(),
                       htmlOutput("txt46"),tags$head(tags$style("#txt46{font-size: 17px;font-style: italic;}")),
                       br(),
                       htmlOutput("txt44"),tags$head(tags$style("#txt44{font-size: 17px;font-style: italic;}")),
                       br(),
                       htmlOutput("txt47"),tags$head(tags$style("#txt47{font-size: 16px;font-style: italic;}")),
