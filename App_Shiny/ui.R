              ...
              conditionalPanel(
                ...
                conditionalPanel(
                  ...
                  selectizeInput("show_vars", "Campos posibles a elegir:",
                                 c("Sexo"="Info.Sexo",
                                   "Edad"="Info.Edad",
                                   "Núm.Adultos"="V01_Casa_Adultos","Núm.Niños"="V02_Casa_Ninos","Cúantos.Kinder"="DF_kinder",
                                   "Cúantos.Primaria"="DF_primaria","Cúantos.Secundaria"="DF_secundaria","Cúantos.Bachillerato"="DF_bachillerato","Cúantos.Licenciatura"="DF_licenciatura",#"Cúantos.Posgrado"="DF_posgrado",
                                   ...
                                   "Ingreso.Sem"="DE05_ingreso_sem","Jefe.Escolaridad"="DE06_esc_jefe","Cúantos.Sin.Ingreso"="DE07_sIngreso","Tiempo.A.Trabajo"="DE08_tmp","Colonia.Trabajo"="DE09_col","Municipio.Trabajo"="DE10_mun", "Estado.Origen"="IyC02_Estado_Origen",
