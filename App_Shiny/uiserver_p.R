...
server <- function(input, output, session) {
  ...
  observeEvent(input$popPyM, {
    showModal(modalDialog(
      title = HTML("PoblaciÃ³n y migraciÃ³n<br>",
                   "I.	DATOS FAMILIARES <br><br>1. Â¿CuÃ¡ntas personas viven en esta casa?<br>Adultos (Â¿Cuantas personas viven en esta casa? Adultos) <br>NiÃ±os (Â¿Cuantas personas viven en esta casa? NiÃ±os)<br><br>  1. A quÃ© niveles de escolaridad asisten los integrantes de esta familia, puede marcar mÃ¡s de una opciÃ³n<br><br>JardÃ�n de niÃ±os (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Jardin de niÃ±os)<br>Primaria (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Primaria)<br>Secundaria (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Secundaria)<br>Bachillerato (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Bachillerato)<br>Licenciatura (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Licenciatura)<br>Posgrado (A quÃ© nivel de escolaridad asisten los integrantes de esta familia Posgrado)<br>2.Â¿QuÃ© medio de transporte utiliza para ir a la escuela, al trabajo, etc? <br><br>AutobÃºs (Â¿QuÃ© medios de transporte utilizan para ir a la escuela, al trabajo, etc? Transportes Posibles)<br>Combi, colectivo<br>Taxi<br> Mototaxi<br>Motocicleta<br> AutomÃ³vil propio<br>Otro3. Â¿DÃ³nde adquiere sus vÃ�veres?<br><br>Mercado de la colonia (Â¿DÃ³nde compra sus vÃ�veres? Posibles)<br>Tienda de abarrotes, carnicerÃ�as<br>sÃºper mercado<br>Tienda de conveniencia (Oxxo,7eleven, â¦)<br>Plaza comercial<br> Otro (Â¿DÃ³nde compra sus vÃ�veres? Otro)   4.Â¿A dÃ³nde acude en caso de urgencia mÃ©dica? (Â¿A dÃ³nde acude en caso de urgencia mÃ©dica? Posibles) <br><br>Me atiendo en casa<br>MÃ©dico particular en la comunidad<br>MÃ©dico particular CancÃºn<br>Hospital General CancÃºn<br>Cruza roja<br>Otro (Â¿A dÃ³nde acude en caso de urgencia mÃ©dica? Otro)<br>5. Â¿Con quÃ© Ã¡reas de recreo cuenta su colonia? <br><br>Parque (Â¿Con quÃ© Ã¡reas de recreo cuenta su colonia? Posibles)<br>Unidad deportiva<br>Jardines<br>Casa de la cultura<br>Biblioteca<br>Otro<br>II.	IDENTIDAD Y COMUNIDAD<br><br>6.Â¿CuÃ¡l es su lugar de origen?  (Â¿CuÃ¡l es su lugar de origen? Estados del paÃ�s, Â¿CuÃ¡l es su lugar de origen? Especifique)<br><br>1 Tabasco<br>2 Chiapas<br>3 YucatÃ¡n<br>4 Quintana Roo<br>5 Veracruz<br>6 CDMX<br>7 Otro______________<br><br>7.Â¿CuÃ¡nto tiempo lleva viviendo en este lugar?  (Â¿CuÃ¡nto tiempo lleva viviendo en este lugar? Opciones)<br>1 ReciÃ©n lleguÃ©<br>2 Un aÃ±o<br>3 Dos aÃ±os<br>4 MÃ¡s de dos aÃ±os<br>5 Toda mi vida<br>8.Razones por las que llegÃ³ a vivir a la localidad)<br><br>1 parientes (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Tengo Parientes,)<br>2 amigos  (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Tengo amigos)<br>3 trabajo (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Por trabajo)<br>4 negocio  (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Por poner negocio,)<br>5 vivir mejor (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Por oportunidad de vivir mejor)<br>5 otro Especifique (Â¿QuÃ© lo motivÃ³ a venir a vivir esta la localidad Otro)<br>9.En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn problema acudo a: <br><br>1 Grupo de vecinos (En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn, problema acudo a Grupo de vecinos)<br>2 Familiares  (En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn, problema acudo a Familiares)<br>3 A la autoridad (En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn, problema acudo a A la autoridad)<br>      4 La iglesia o templo (En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn, problema acudo a La iglesia o templo)<br>5 otro Especifique (En caso de requerir ayuda, apoyo legal, econÃ³mico o familiar ante algÃºn, problema acudo a Otro)<br>10.Â¿QuÃ© religiÃ³n practica? (Â¿QuÃ© religiÃ³n practica? Opciones)<br><br>1 Ninguna<br>2 CatÃ³lica<br>3 EvangÃ©lica<br>4 Testigos de JehovÃ¡<br>5 Adventista<br>6 MormÃ³n<br>7 Otra (Â¿QuÃ© religiÃ³n practica? Otro)<br>11.Â¿CuÃ¡les son sus principales costumbres o tradiciones? (Â¿CuÃ¡les son sus principales costumbres o tradiciones? Opciones)<br><br>1 Fiestas en honor a la Virgen de FÃ¡tima<br>2 Fiestas patronales<br>3 Festival de la cultura del Caribe<br>4 Carnaval <br>5 Fin de aÃ±o<br>6 DÃ�a de muertos<br>7 Otro (Â¿CuÃ¡les son sus principales costumbres o tradiciones? Otro<br>12.Â¿CuÃ¡les son las ventajas de vivir en esta comunidad?<br><br>1 Tengo casa (Â¿CuÃ¡les son las ventajas de vivir en esta comunidad? Tengo casa)<br>2 Trabajo (Â¿CuÃ¡les son las ventajas de vivir en esta comunidad? Tengo trabajo)<br>3 Familia (Â¿CuÃ¡les son las ventajas de vivir en esta comunidad? Tengo familia)<br>4 Tengo mÃ¡s tiempo (Â¿CuÃ¡les son las ventajas de viv en esta comunidad? Tengo mas tiempo)<br>5 Es tranquilo (Â¿CuÃ¡les son las ventajas de vivir ir  en esta comunidad? Es tranquilo)<br>6 Es seguro (Â¿CuÃ¡les son las ventajas de vivir en esta comunidad? Es seguro)<br>7 Otro (Â¿CuÃ¡les son las ventajas de vivir en esta comunidad? Otro)<br>13. Piensa irse a vivir a otra localidad (Piensa irse a vivir a otra localidad Opciones)<br><br>1 No <br>2 QuizÃ¡s <br>3 SÃ�, en el mismo estado <br>4 SÃ�, me regreso a mi lugar de origen <br>5 SÃ�, al extranjero<br>14.Â¿Con quÃ© municipio de identifica mÃ¡s? (Â¿Usted a quÃ© municipio siente que pertenece? Opciones)<br><br>1 Benito JuÃ¡rez<br>2 Isla Mujeres<br><br>3 Ninguno<br>15.Â¿QuÃ© tan frecuente va a la isla, la cabecera municipal de Isla Mujeres? (Â¿QuÃ© tan frecuente va a la Isla, la cabecera municipal de Isla Mujeres? Opciones)<br><br>1 Nunca <br>2 A veces [varias veces al aÃ±o] <br>3 Frecuentemente [al menos una vez al mes]<br>4 casi Siempre [mÃ¡s de una vez al mes]<br>5 Siempre [una vez por semana]<br><br>16.Â¿Cuales son los motivos por los que viaja a isla? <br><br>1 Asuntos administrativos (Â¿Cuales son los motivos por los que viaja a isla? Asuntos administrativos)<br>2 Pagos de servicios (Â¿Cuales son los motivos por los que viaja a isla? Pagos de servicios)<br>3 Trabajo (Â¿Cuales son los motivos por los que viaja a isla? Trabajo)<br> 4 RecreaciÃ³n (Â¿Cuales son los motivos por los que viaja a isla? RecreaciÃ³n)<br> 5 Visita de la familia (Â¿Cuales son los motivos por los que viaja a isla? Visita de la familia)<br>6 Otros (Â¿Cuales son los motivos por los que viaja a isla? Otro)<br>IV.	VIVIENDA<br><br>La vivienda que habita tu familia es (La vivienda que habita tu familia es Opciones)<br>1 Propia.   <br>2 Prestada por (La vivienda que habita tu familia es Prestado por)<br>3 Rentada y se  paga mensual (La vivienda que habita tu familia es Renta mensual)<br> 4 Asentamiento irregular o informal <br>5 Otro (La vivienda que habita tu familia es Otro)<br>Â¿Ha recibido la visita del municipio para ofrecerle reubicarlo en otro lugar?  (Â¿Ha recibido la visita del municipio para ofrecerle reubicarlo en otro lugar? Si o no)<br>  â¢	SÃ³lo si responde Asentamiento irregular o informal<br><br> Â¿Le indicaron a quÃ© sitio los reubicarÃ�an? (Â¿Le indicaron a quÃ© sitio los reubicarÃ�an? Si o no)<br>â¢	SÃ³lo si responde Asentamiento irregular o informal<br><br>En caso  de ser  propia, Â¿De quÃ© forma fue adquirida? (En caso de ser vivienda propia Â¿De que forma fue adquirida? Opciones)<br>1 Herencia   <br>2 Pago de contado<br>3  PagÃ¡ndola:    <br><br>Monto mensual (En caso de ser vivienda propia Â¿De que forma fue adquirida? Monto mensual)<br>Â¿A quiÃ©n? (En caso de ser vivienda propia Â¿De que forma fue adquirida? A quien)<br>4  No es propia<br><br>Â¿Con quÃ© servicios cuenta su vivienda? <br>1 televisiÃ³n de paga (cable o satelital) <br>2 internet <br>3 servicio telefÃ³nico celular <br>4  energÃ�a elÃ©ctrica <br>5 agua <br><br>Â¿Con quÃ© servicios cuenta su vivienda? (Â¿Con quÃ© servicios cuenta su vivienda?)<br>1 televisiÃ³n de paga (cable o satelital) <br>2 internet <br>3 servicio telefÃ³nico celular <br>4 energÃ�a elÃ©ctrica <br>5 agua <br><br>Â¿CuÃ¡ntas inundaciones ha sufrido al vivir en esta localidad? (Â¿CuÃ¡ntas inundaciones ha sufrido al vivir en esta localidad?)<br><br>Â¿En caso de haber sufrido una inundaciÃ³n quÃ© hizo al respecto? (En caso de haber sufrido una inundaciÃ³n quÃ© hizo al respecto Opciones) <br>â¢	SÃ³lo si ha sufrido inundaciones<br>1 DejÃ© mi casa y fui al refugio<br>2 DejÃ© mi casa y fui a la casa de un familiar o amigo<br>3 AquÃ� nos quedamos<br>4 Vinieron las autoridades a desalojar pero decidimos quedarnos<br>5 Otro (En caso de haber sufrido una inundaciÃ³n quÃ© hizo al respecto Otro)<br><br>A pesar de la inundaciÃ³n usted decidiÃ³ quedarse a vivir aquÃ� por (A pesar de la inundaciÃ³n usted decidiÃ³ quedarse a vivir aquÃ� por  Opciones)<br>â¢	SÃ³lo si ha sufrido inundaciones<br>1 No tengo alternativa de vivienda    <br>2 Me agrada el lugar<br>3 Estoy esperando un crÃ©dito y mientras aquÃ� me quedo<br>4 La ubicaciÃ³n del trabajo y escuela  nos queda mÃ¡s cerca<br>5 No dispongo de un trabajo que me permita acceder a un crÃ©dito para vivienda<br>6 Otro (A pesar de la inundaciÃ³n usted decidiÃ³ quedarse a vivir aquÃ� por  Opciones)<br><br>Â¿Sabe si su vivienda estÃ¡ en zona de riesgo? (Â¿Sabe si su vivienda estÃ¡ en zona de riesgo?)<br><br>Â¿Sabe si su vivienda estÃ¡ en zona de riesgo? Â¿Cuales? (Â¿Sabe si su vivienda estÃ¡ en zona de riesgo? Â¿Cuales?) <br><br>â¢	SÃ³lo si responde sÃ� a la pregunta: Â¿Sabe si su vivienda estÃ¡ en zona de riesgo?<br>Â¿Conoce los impactos o afectaciones que puede sufrir? (Â¿Conoce los impactos o afectaciones que puede sufrir?) <br><br>Â¿Conoce los impactos o afectaciones que puede sufrir? (Â¿Conoce los impactos o afectaciones que puede sufrir? Â¿Cuales?) <br><br>â¢	SÃ³lo si responde SÃ� a la pregunta Â¿Conoce los impactos o afectaciones que puede sufrir?<br>V.	APRECIACIONES DEL ENCUESTADOR<br><br>Favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda <br><br>1 Ãreas verdes (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda Ã¡reas verdes)<br>2 Calles pavimentadas (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda calles)<br>3 Banquetas (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda banquetas)<br>4 Luminarias pÃºblicas (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda luminarias)<br>5 Transporte pÃºblico (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda transporte)<br>6 Patrullas vigilando (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda patrullas)<br>7 Lotes baldÃ�os (favor de seÃ±alar los siguientes servicios observados alrededor de la vivienda lotes baldios)<br>Â¿Que percepciÃ³n tuvo de la vivienda y la calle?<br><br>1 Seguridad  (Â¿Que percepciÃ³n tuvo de la vivienda y la calle? Percepcion seguridad)<br>2 Comodidad (Â¿Que percepciÃ³n tuvo de la vivienda y la calle? Percepcion comodidad)<br>3 Riesgo personal o natural (Â¿Que percepciÃ³n tuvo de la vivienda y la calle? Percepcion riesgo personal o natural)  <br>"),
      easyClose = TRUE
    ))
  })
  ...
  observeEvent( input$poSyA, {
    showModal(modalDialog(
      title = HTML("DiagnÃ³stico socio econÃ³mico y ambiental<br>",
                   "Social <br><br>1. Entre los vecinos, realizan alguna actividad en comÃºn:  fiestas, reuniones vecinales, levantar quejas etc <br>2. Â¿CÃ³mo es la relaciÃ³n con sus vecinos? <br>3. Â¿Ha tenido problemas con sus vecinos: pleitos, demandasâ¦? <br>4. Â¿Con quÃ© frecuencia se hacen favores entre vecinos? <br>5. Â¿En algÃºn problema que se le presente, sus vecinos le ayudan? <br>6. Â¿Pertenecen a alguna organizaciÃ³n? <br><br>Economico <br><br>1.  Â¿CuÃ¡ntas personas de esta familia trabajan? <br>2.  Â¿En quÃ© trabajan? <br>3. Â¿Realizan alguna actividad productiva por su cuenta: manualidad, artesanÃ�a u oficio, cultivo de hortalizas?<br>4. Â¿Intercambian productos con sus vecinos? <br>5. Â¿Se ayudan entre vecinos para algÃºn trabajo que beneficie la economÃ�a familiar dentro de sus casas?<br><br>Ambiental <br><br>1. Â¿QuÃ© uso le dan sus vecinos a la salina? <br>2.Â¿QuÃ© beneficio recibe de vivir aquÃ�?<br>3.Â¿QuÃ© desventajas recibe de vivir aquÃ� cerca de la salina? <br>4.Â¿En quÃ© condiciones considera que se encuentra la salina? <br>5.Â¿QuÃ© efectos genera la condiciÃ³n (sucia o contaminada) de la Salina? <br>6.Â¿Han llevado a cabo alguna actividad de limpieza, saneamiento o conservaciÃ³n de la Salina?<br>7.Â¿EstÃ¡n conectados al drenaje?<br>8.Â¿Por quÃ© decidieron vivir aquÃ�?<br>"),
      easyClose = TRUE
    ))
  })
  ...
  ##-- + Dados do candidato e eleiÃ§Ã£o selecionada ----
  observe({
  ...
  output$localiz <- renderText ({
    if(input$tipomapa=="ALL"){ "CancÃºn - Isla Mujeres " }
    else if(input$tipomapa=="PS"){ "CancÃºn, QRoo." }
  ...
  output$TipoestudioG <- renderText ({
    if(input$tipomapa=="PS"){ "PercepciÃ³n sobre seguridad" }
    else if(input$tipomapa=="IS"){ "Estudio SocioeconÃ³mico y ambiental" }
    else if(input$tipomapa=="EJ"){ "CaracterÃ�sticas sobre poblaciÃ³n y migraciÃ³n"}
  })
  ...
  output$Tipoestudio <- renderText ({
    if(input$showmapa=="ALL"){ "Estudios socioeconomicos, PercepciÃ³n de seguridad y CaracterÃ�sticas sobre poblaciÃ³n y migraciÃ³n. " }
    else if(input$showmapa=="PS"){ "PercepciÃ³n sobre seguridad" }
    else if(input$showmapa=="IS"){ "Estudio SocioeconÃ³mico y ambiental" }
    else if(input$showmapa=="EJ"){ "CaracterÃ�sticas sobre poblaciÃ³n y migraciÃ³n"}
  })
  ...
  output$zona <- renderText ({
    if(input$showmapa=="ALL"){ "CancÃºn - Isla Mujeres " }
    else if(input$showmapa=="PS"){ "CancÃºn - Isla Mujeres" }
  ...
  output$txt3 <- renderText({
    ...
    if(any('DE08_tmp'==input$show_vars)){
      word <- paste("<b>","o El tiempo que tarda el jefe de familia en llegar a su trabajo esta categorizado de la siguiente manera: ","</b>",tags$ul(
        ...
        tags$li("C - Mas de 20 min y menos de 1 hora"), 
        tags$li("D - Entre 1 y 2 horas"), 
        tags$li("E - Mas de 2 horas")))
    }else{
      word <-paste("")
    }
    HTML(paste(word))
  ...
  output$txt4 <- renderUI({
    word <- paste("<b>",tags$i("o Descripcion del grafo:"),"</b>",tags$i("Los nodos del grafo indican las reglas de asociacion que se obtienen con las columnas seleccionadas, 
                 estas se conectan por medio de flechas que van del antecedente al consecuente. En el medio de estas flechas de conexiones, podemos encontrar un circulo cuyo tam. 
                                                                         representa el valor de soporte o frecuencia de la regla mientras que el color representa la confianza. 
                                                                         Podemos ver que la confianza se representa desde rosa palido hasta el rojo, siendo este ultimo el valor mas alto."))
    HTML(paste(word))
  })
  
  dat<-reactive({
    #unique(read.table(file='./CSV/ps/columnas1.csv', sep=',', header = TRUE, stringsAsFactors = FALSE, fileEncoding="latin1")[, input$show_vars, drop = FALSE])
    df_ide <- read.table(file='./CSV/ps/columnas1.csv', sep=',', header = TRUE, stringsAsFactors = FALSE, fileEncoding="latin1")
