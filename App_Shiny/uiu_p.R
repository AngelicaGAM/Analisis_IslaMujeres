...
sidebar <- dashboardSidebar(
        sidebarMenu(id="tabs",
                    ...
                    conditionalPanel(condition = "input.tabs == 'graficas'", id="tabsS",
                                     selectInput(inputId='tipomapa', label = h3('Estudio:'),  choices = c("Percepcion de seguridad" = "PS", "SocioeconÃ³mico y ambiental" = "IS" ,"PoblaciÃ³n y migraciÃ³n" = "EJ"), selected = "EJ")
        ...
        tabItems(
                ...
                tabItem(tabName = "inicio",
                        fluidRow(
                                column(12,
                                       wellPanel(
                                               HTML(" <h2><b>Estudios Socio-EconÃ³micos, PercepciÃ³n de Seguridad y CaracterÃ�sticas sobre poblaciÃ³n y migraciÃ³n. </b></h2>"),br(),
                                               infoBox( "PoblaciÃ³n y migraciÃ³n",377 , icon=icon("user-alt"), color = "light-blue", fill = TRUE ),
                                ...
                                column(4, wellPanel(
                                        HTML(" <h2><b>CaracterÃ�sticas sobre poblaciÃ³n y migraciÃ³n.</b></h2><h3>  Zona Urbana Isla Mujeres</h3><h4>Enfoque exclusivo a la percepciÃ³n de seguridad en la Zona Continental de Isla Mujeres tomando los resultados de ambos conjuntos de datos realizados por diferentes instituciones.<br> <br>Enfoque:<br> <ul><li>Economico</li><li>Social</li><li>Vivienda</li><li>ApreciaciÃ³n de encuestador </li> <br><br></h4>"),
                                        actionBttn(inputId = "popPyM", label = "Cuestionario", style = "fill", color = "danger", icon = icon("poll-h"), size = "sm")
                                )),
                                column(4,wellPanel(             
                                        HTML(" <h2><b>DiagnÃ³stico socio econÃ³mico y ambiental.</b></h2><h3>  Salinas, Isla Mujeres.</h3><h4>Estudio enfocado en las colonias que colindan con las Salinas localizadas en el municipio de Isla Mujeres. <br> <br>Enfoque:<br> <ul><li>Economico</li><li>Social</li> <li>Ambiental</li> <br><br></h4>"),
                                        actionBttn(inputId = "poSyA", label = "Cuestionario", style = "fill", color = "danger", icon = icon("poll-h"), size = "sm") 
                                )),
                                column(4, wellPanel(
                                        HTML(" <h2><b>Estudio de percepciÃ³n de seguridad.</b></h2><h3>  Estado de Quintana Roo.</h3><h4> Estudio donde 16,671 encuestas vÃ¡lidas aplicadas en el Estado de Quintana Roo, donde 9,233 son en Benito JuÃ¡rez/Puerto Morelos y 208 en Isla Mujeres(Isla y Zona Urbana Ejido)<br> <br>Enfoque:<br> <ul><li>PercepciÃ³n de seguridad </li><br><br></h4>") ,
                ...
                tabItem(tabName = "graficas",
                        fluidRow(
                                ...
                                column(6, wellPanel(
                                        selectInput(inputId='enfoque', label = h3('Enfoque:'), choices= c("Datos generales del encuestado" = "DG", "Datos familiares" = "DF","Datos econÃ³micos" = "DE", "Identidad y Comunidad" = "ID" , "Vivienda" = "VI", "ApreciaciÃ³n del encuestador" = "AE"), selected = "VI") 
                                )), 
                                column(6, wellPanel(
                ...
                tabItem(tabName = "mapas",
                        div(class="outer",
                            ...
                            absolutePanel(id = "controls", class = "panel panel-default", 
                                          ...
                                          selectInput(inputId='showmapa', label = h3('Estudio:'), choices = c("Todos" = "ALL" ,"Percepcion de seguridad" = "PS", "Estudio SocioeconÃ³mico y ambiental" = "IS" ,"PoblaciÃ³n y migraciÃ³n" = "EJ")),
