...
lexicon <- stop_words$lexicon[1:147]
...
#write.csv(bigrams_separated, file="UC/Proyecto Terminal/Analisis_IslaMujeres/bigrams_separated.csv")
bigrams_separated <- read.csv("UC/Proyecto Terminal/Analisis_IslaMujeres/bigrams_separated.CSV", header = TRUE, sep=",", strip.white = TRUE, na.strings = "EMPTY")
bigrams_separated
