...
AMB4 = graficarPlot(VI04,"PERCEPCIÓN ", "Número de personas", "AMBIENTAL - P4 - PERCEPCI�N DEL ESTADO DE LA SALINA" )
...
SOC1 = graficarPlot(VI04,"RESPUESTA", "Número de personas", "SOCIAL - P1 - SE REALIZAn ACTIVIDADES VECINALES EN COMUN" )
...
SOC2 = graficarPlot(VI04,"PROBLEMAS", "Número de personas", "SOCIAL - P2 - RELACIÓN ENTRE " )
...
SOC3 =graficarPlot(VI04,"RESPUESTA ", "Número de personas", "SOCIAL - P3 - FAVORES VECINALES" )
